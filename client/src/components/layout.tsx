...
function SidebarContent({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "hsl(220 25% 12%)" }}
    >
      {/* Logo Header */}
      <div
      ...
      >
        ...
        {onClose && (
          <button
            ...
            style={{ color: "hsl(210 20% 65%)" }}
            onMouseEnter={(e) =>
              (e.currentTarget.style.backgroundColor = "hsl(220 22% 20%)")
            }
            onMouseLeave={(e) =>
                  ...
                  >
                    <item.icon
                      style={{
                        ...
                        height: "17px",
                        flexShrink: 0,
                        color: isActive ? "#fff" : "hsl(210 25% 62%)",
                      }}
                    />
      ...
      <div
        className="px-2 py-2"
        style={{ borderTop: "1px solid hsl(220 22% 20%)" }}
      >
        ...
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.backgroundColor = "hsl(220 22% 20%)";
            e.currentTarget.style.color = "hsl(210 30% 88%)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor = "";
            e.currentTarget.style.color = "hsl(210 25% 65%)";
          }}
        ...
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.backgroundColor = "hsl(0 60% 15%)";
            e.currentTarget.style.color = "hsl(0 80% 75%)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor = "";
            e.currentTarget.style.color = "hsl(0 60% 65%)";
          }}
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="relative text-foreground/70 hover:text-foreground hover:bg-accent/50 rounded-full h-9 w-9"
...
function BranchSelector() {
  ...
  return (
    ...
    >
      <SelectTrigger
        className="h-8 text-xs border-border/60 bg-background/50 w-36 md:w-44 gap-1"
...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const currentPage =
    navigation.flatMap((s) => s.items).find((item) => item.href === location)
      ?.name || "Dashboard";
  ...
  return (
    <div className="flex min-h-screen w-full bg-background">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-72 bg-sidebar text-sidebar-foreground shadow-2xl transform transition-transform duration-300 ease-in-out lg:hidden ${mobileSidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
