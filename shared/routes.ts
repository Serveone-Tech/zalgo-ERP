...
export const api = {
  ...
  teachers: {
    list: {
      ...
      responses: { 200: z.array(z.custom<typeof teachers.$inferSelect>()) },
    },
    create: {
      method: "POST" as const,
      path: "/api/teachers" as const,
  ...
  enrollments: {
    list: {
      ...
      responses: { 200: z.array(z.custom<typeof enrollments.$inferSelect>()) },
    },
    create: {
      method: "POST" as const,
      path: "/api/enrollments" as const,
  ...
  fees: {
    list: {
      ...
      responses: { 200: z.array(z.custom<typeof fees.$inferSelect>()) },
    },
    create: {
      method: "POST" as const,
      path: "/api/fees" as const,
